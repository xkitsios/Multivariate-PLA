...
def main(filenames, e_vals, multivariate=True, univariate=True):
    ...
    if multivariate:
        print('Multivariate mode is not currently supported')
...
if __name__ == "__main__":
    files = ['dataset/AristotelousCleanTempScaled.csv',
    ...
    main(files, [1, .5, .25, .125, .025], multivariate=True, univariate=True)
